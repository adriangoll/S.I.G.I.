...
export const exportarNominaAExcel = (data: IDocenteNomina[], division: string, materia: string) => {
...
export const exportarCalificacionesAExcel = (data: ICalificacionDocente[], instancia: string) => {
    const rows = data.map(item => ({
        "DNI": item.dni,
